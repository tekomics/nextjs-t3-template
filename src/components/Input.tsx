...
const style = tv({
  base: 'block w-full rounded-md border-0 !outline-none py-1.5 ring-1 ring-inset focus:ring-inset focus:ring-2 transition-all',
  variants: {
    color: {
      default:
...
export default function Input({
  ...
  const inputClassName = style({ color: colorStyle, icon: iconStyle });
